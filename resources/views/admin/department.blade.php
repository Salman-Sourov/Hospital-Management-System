...
<head>
    ...
    <title>All Department | MSHL </title>
    <!-- Favicon icon -->
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-sm-4 mb-3">
					...
					<div>
						<a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal" data-target="#addOrderModal">+New Department</a>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="{{route('ad_dept')}}" method="post" >
								@csrf
										...
										<td>
											<div class="dropdown ml-auto text-right">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="{{url('/department_delete/'.$item['id'])}}">Delete</a>
												</div>
											</div>
										</td>
									</tr>
