        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">All Service Info</h2>
						<p class="mb-0"></p>
					</div>
					<div>
						<a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal" data-target="#addOrderModal">+Add Service</a>
							...
							<div class="modal-body">
								<form action="{{route('addservice')}}" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="text-black font-w500">Service Title</label>
										<input type="text" name="title" class="form-control">
									</div>
                                    <div style="margin-top:30px ;" class="form-group">
										<label class="text-black font-w500">Upload Logo</label>
							...
							<table id="example5" class="display dataTablesCard table-responsive-xl">
								...
								@foreach($service as $item)
									<tr>
										...
										<td>{{$item['title']}}</td>
										<td><img style="height:50px; width:50px ;" src="/uploads/content/{{$item['logo']}}" alt="Icon"></td>
										...
										<td>
											<div class="dropdown ml-auto text-right">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="{{url('/service_delete/'.$item['id'])}}">Delete</a>
												</div>
											</div>
										</td>
									</tr>
