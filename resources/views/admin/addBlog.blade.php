        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="form-head d-flex mb-sm-4 mb-3">
                    <div class="mr-auto">
                        <h2 class="text-black font-w600">Add Blogs</h2>
                        
                    </div>
                    <div>
                        <a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal" data-target="#addOrderModal">+New Blogs</a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('ad_blog')}}" method="post" enctype="multipart/form-data">
                                    @csrf
										...
										<td>
											<div class="dropdown ml-auto text-right">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="{{url('/edit_blog/'.$item['id'])}}">Edit</a>
													<a class="dropdown-item" href="{{url('/blog_delete/'.$item['id'])}}">Delete</a>
												</div>
											</div>
										</td>
									</tr>
