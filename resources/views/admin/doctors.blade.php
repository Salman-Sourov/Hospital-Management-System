					...
					<div class="modal-dialog" role="document">
						<div style="overflow:scroll; height:600px;"class="modal-content">
							...
							<div class="modal-body">
								<form action="{{route('ad_doctor')}}" method="post" enctype="multipart/form-data">
									@csrf
									...
									<div class="form-group">
										...
										<input type="text" name="visit_time" class="form-control" placeholder="Example= (Saturday,Sunday,Monday) at 4pm-7pm" required>
									</div>
							...
							<table id="example5" class="display dataTablesCard table-responsive-xl">
								...
								@foreach($doctors as $item)
									<tr>
										...
										<td><span class="text-nowrap">{{$item['id']}}</span></td>
										...
										<td><img style="height:50px; width:50px ;" src="/uploads/doctor/{{$item['images']}}" alt="Icon"></td>
										...
										<td>
											<div class="dropdown ml-auto text-right">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="{{url('/edit_doctor/'.$item['id'])}}">Edit</a>
													<a class="dropdown-item" href="{{url('/doctor_delete/'.$item['id'])}}">Delete</a>
												</div>
											</div>
										</td>
									</tr>
