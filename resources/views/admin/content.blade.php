					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="{{route('ad_content')}}" method="post" enctype="multipart/form-data">
                                    @csrf
									<div class="form-group">
										<label class="text-black font-w500">Content Title</label>
									...
									<div style="margin-top:30px ;" class="form-group">
										<label class="text-black font-w500">Upload Content</label>
							...
							<table id="example5" class="display dataTablesCard table-responsive-xl">
								...
								@foreach($content as $item)
									<tr>
										...
										<td><img style="height:50px; width:50px ;" src="/uploads/content/{{$item['content']}}" alt="Icon"></td>
										...
										<td>
											<div class="dropdown ml-auto text-right">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="{{url('/photo_delete/'.$item['id'])}}">Delete</a>
												</div>
											</div>
										</td>
									</tr>
