...
<head>
	...
	<title>Millenium Specialized Hospital Dashboard</title>
	<!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="{{asset('./admin/ico/logo.png')}}">
    ...
    ***********************************-->
	<div id="main-wrapper">
		...
		<!--**********************************
            Nav header start
        ***********************************-->
		<div style="width:auto;" class="nav-header">
            <a href="" class="brand-logo">
			<img style=" height:50px; margin:-7px " src="{{asset('images/logo.png')}}" alt="Image">
                <img class="logo-compact" src="{{asset('./admin/ico/logo.png')}}" alt="">
                <img class="brand-title" src="{{asset('./admin/ico/logo.png')}}" alt="">
            </a>
			...
			<div class="container-fluid">
				<div class="form-head d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						...
						<p class="mb-0">Millennium Specialized Hospital Admin Dashboard </p>
					</div>
							...
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600">{{$departments}}</h2>
					...
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600">{{$doctors}}</h2>
